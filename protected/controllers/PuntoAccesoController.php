...
class PuntoAccesoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('PuntoAcceso');
	 ...
	 * @return PuntoAcceso the loaded model
	 ...
	 * @param PuntoAcceso $model the model to be validated
	 */
