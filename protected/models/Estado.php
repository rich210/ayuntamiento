...
class Estado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, cancelado, fecha_creacion, fecha_modificacion, pais_id', 'required'),
			array('cancelado', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>45),
			array('pais_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, cancelado, fecha_creacion, fecha_modificacion, pais_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'tblMunicipios' => array(self::HAS_MANY, 'TblMunicipio', 'estado_id'),
			'tblPersonas' => array(self::HAS_MANY, 'TblPersona', 'estado_id'),
			'tblPoblacions' => array(self::HAS_MANY, 'TblPoblacion', 'estado_id'),
			'tblUnidadHabitacionals' => array(self::HAS_MANY, 'TblUnidadHabitacional', 'estado_id'),
		);
	}
